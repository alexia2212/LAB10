...
<!doctype html>
<% ArrayList<Clientes> listarcontratos = (ArrayList<Clientes>) request.getAttribute("listaContratos");
...
<head>
    ...
    <title>LAB10_Iniciar Sesión</title>
    <style>
        body {
...
<a class="btn btn-primary" href="<%=request.getContextPath()%>/index" role="button"
